...
namespace Dolanan.Editor.ImGui
{
    ...
    public class ImGuiRenderer
    {
        ...
        public virtual void DrawLayout(Type type)
        {
            // Drawing using reflections
        ...
        public ImGuiIOPtr GetIOPtr => ImGui.GetIO();

        /// <summary>
        ///     Enable MonoGame input. Call this at the Initialization of the top project.
        ///     How : let say you have GameProject, it has class Game1 : GameMin. Call this function at Game1.Initialization
        ///     Why not call it at GameMin.Initialization? it will throw error, maybe colliding between dependency
        /// </summary>
        public void SetupMonoGameWindowInput()
        {
            if (_game == null) return;
            // MonoGame-specific //////////////////////
            _game.Window.TextInput += (sender, args) =>
            {
                if (args.Character == '\t') return;
				
                GetIOPtr.AddInputCharacter(args.Character);
            };
        }
        ...
        private unsafe void UpdateBuffers(ImDrawDataPtr drawData)
        {
            ...
            if (drawData.TotalVtxCount > _vertexBufferSize)
            {
                ...
                _vertexBuffer = new VertexBuffer(_graphicsDevice, DrawVertDeclaration.Declaration,
